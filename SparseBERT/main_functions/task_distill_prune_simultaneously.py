...
def main():
    ...
    if args.do_eval:
        ...
        output_eval_on_trainset_file = os.path.join(args.output_dir, "eval_results_on_trainset.txt")
        ...
        # num_steps_per_epoch * 10, 800
        # num_steps_per_epoch * 8,  600
        ...
        for epoch_ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration", ascii=True)):
                ...
                if (global_step + 1) % args.eval_step == 0:
                    ...
                    result = do_eval(student_model, task_name, eval_dataloader, device, output_mode, eval_labels, num_labels)
                    ...
                    # # 15 min for RTE each time of evaluation on train set
                    # if (global_step + 1) % 2000 == 0:
                    #     result_train = do_eval(student_model, task_name, train_dataloader, device, output_mode, train_labels, num_labels)
                    #     result_to_file(result_train, output_eval_on_trainset_file)
